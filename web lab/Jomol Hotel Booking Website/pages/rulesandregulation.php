<html>
	...
	<head>
		...
		<link rel="stylesheet" href="../css/rules_css.css"/>
	</head>
<body>
	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div id="rules_title_div">
					<h2>RULES AND REGULATION</h2>
					<div><img src="../guideline_gif.gif"/></div>
				</div>
				
				<div id="rules_container">
					<div class="rules_div">
						<h4 style = "color:#ff0000;">1. Tariff</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">2. Settlement of Bills</h4>
						<p>Bills must be settled on presentation, personal cheques are not accepted.</p>
					</div>
	
					<div class="rules_div">
						<h4 style = "color:#ff0000;">3. Company's Lien on Guest's Luggage and Belongings</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">4. Check-in</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">5. Departure</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">6. Luggage Storage</h4>
					...
					<div class="rules_div">
					<h4 style = "color:#ff0000;">9. Damage to Property</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">10. Management's Rights</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">11. Relation between Management and Guest</h4>
					...
					<div class="rules_div">
						<h4 style = "color:#ff0000;">12. Government rules and regulations and application of laws</h4>
